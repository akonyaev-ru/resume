/* Пиксельный паучок, который живёт внизу страницы: ходит вдоль нижнего края,
   раскрывает ноутбук и печатает — полоска-экран при этом меняет цвет, — а на
   курсор и щелчок отзывается.
...
(function () {
  ...
  var ART_W = 34;            // ширина рисунка: паучок и место под ноутбук
  var ART_H = 18;
  ...
  var COLORS = {
    o: '#161c28',            // тень под ноутбуком
    '#': '#7c7cff',          // тело
    d: '#5b5bd6',            // лапки и корпус ноутбука
    D: '#3f3f9e',            // брюшко
    w: '#e7eaf2',            // глаза
    a: '#ffb454',            // экран горит янтарным
    m: '#3ddc97',            // ...мятным
    i: '#a5a5ff',            // ...и светлым индиго
  };

  /* Кадры: точка — пусто, буква — цвет из COLORS. Паучок занимает левую часть
