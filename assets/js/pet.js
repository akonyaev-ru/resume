...
(function () {
  ...
  /* Точка — пусто, буква — цвет из палитры. Кадры тела одни на двоих:
     ...
     никогда: у каждого свой ноутбук, у Оливии мельче. Кадры перерисовывает
  ...
  // Ноутбук Оливии: мельче, чем у Отто, и с наклейкой на крышке.
  var NETBOOK = [
    [
        '.......',
        '.......',
  ...
  // Он же с двумя щупальцами на клавишах.
  var NETBOOK_TYPE = [
    [
        '.......',
        '.......',
