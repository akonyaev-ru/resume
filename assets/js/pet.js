...
(function () {
  ...
  var SKIN = {
    ...
    olivia: {
      ...
      /* Кружка горчичной глазури — тот же цвет, что у пледа на диване: новых
         красок в палитре не появляется. Белый фарфор был самым ярким пятном во
         всей нижней полосе и тянул глаз сильнее текста. Корпус кружки не может
         краситься буквой `w`: ею набраны белки глаз в кадрах тела, и обе
         палитры общие. */
      c: '#c9a227',          // глазурь корпуса
      s: '#8f7018',          // кромка и кольцо ручки: темнее глазури
