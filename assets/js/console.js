...
(function (root) {
  ...
  var SPECIALS = { hole: 5, acid: 3, rainbow: 3, stone: 7, virus: 3 };   // ключ → вес при розыгрыше (5.50: камень; 5.54: камень 6; 5.63: вирус 3; 5.68: радуга 2; 5.70–5.71: лазер 2 → 3; 5.73: лазер снят, радуга 3; 5.74: камень 7 — «чуть-чуть камней добавь»)
  var SPECIAL_CHANCE = 0.27;   // доля фигур со спецклеткой (5.63: 0,25; 5.68: 0,27; 5.74: дыра 6,4 %, кислота и радуга по 3,9 %, камень 9,0 %, вирус 3,9 % — полезные 14,1 %, помехи 12,9 %)
  ...
  var NEUTRAL = '#c9d1dc';   // клетка без фигуры — значок вируса в легенде
