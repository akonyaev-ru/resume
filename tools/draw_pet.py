...
Кадры одни на двоих. Отто и Оливия отличаются только палитрой, а клетки румянца
помечены буквой `r`, и каждый берёт по ней своё: у Оливии он розовый, у Отто —
цвет тела, то есть ничего. Так две фигуры не разъедутся между собой при первой
же правке позы.
