...
# Кольцо стоит со стороны Оливии, и **щупальце продето в него**: нижнюю
# перекладину кольца рисует само щупальце. Так видно и кружку, и то, что её
# держат за ручку. До этого перебрали три расстановки: ручка прижата к корпусу
...
def mug(lift, steam=None):
    ...
    rect(g, ring, top + 3, ring + 1, top + 3, 'd')  # щупальце вместо низа кольца
    rect(g, 0, bottom, ring, bottom, 'd')           # и вниз, к самой Оливии
