...
LEGS = {
    ...
    # Сидя свисают только две пары: четыре свисающих щупальца читались частоколом.
    'dangle': ((3, 4), (7, 8), (-1, -1), (-1, -1)),
}
...
BODY_FRAMES = [
    ...
    ('sit', [
        lambda: body(legs='dangle', lift=1, hang=True, step=1),
        lambda: body(legs='dangle', lift=1, hang=True, step=2),
    ]),
