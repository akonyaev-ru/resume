...
# Лист бумаги: три клетки в ширину, шесть в высоту и с наклоном — каждые две
# строки он уходит на клетку вправо. Наклон тут и делает бумагу бумагой:
...
PAPER_W = 3
PAPER_H = 6
PAPER_BOTTOM = (GROUND, GROUND - 2, GROUND - 3, GROUND - 4)   # по шагам подъёма
