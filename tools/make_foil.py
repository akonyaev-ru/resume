...
WIDTH = 560
HEIGHT = 700
BANDS = 9.5             # сколько цветных полос укладывается по диагонали
WARP = 2.2              # насколько сильно шум коробит полосы
SCANLINE = 0.16         # глубина построчной штриховки
SEED = 11
...
def main() -> int:
    ...
    out = colour * (0.52 + 0.32 * highlight)[..., None] + 225.0 * highlight[..., None]
